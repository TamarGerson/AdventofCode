...
public class DaySeven {
    ...
    /**
     * this function checks what is the length of a given file
     * @param filePath filepath
     * @return length of file
     */

    protected static long fileLength(String filePath){
        long length = 0;
    ...
    private  static int whatKind(String hand){
        ...
        int is2 = 0 ;
        boolean is3 = false ;
       // String curHand = String.valueOf(hand);
     ...
     */
    public static long totalWinnings(String filePath){
        long answer;
        try {
    ...
    public static void main(String[] args) {
        if(args.length != 1){
            ...
            long sixthDayAnswerPt1 = totalWinnings(args[0]) ; //first challenge
            System.out.println(sixthDayAnswerPt1);
        }
    }
}
